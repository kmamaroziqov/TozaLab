...
# Booking Route
@routes.route('/booking/<int:service_id>', methods=['GET', 'POST'])
@login_required
def booking(service_id):
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('routes.checkout', booking_id=booking.id))
    return render_template('booking.html', service=service, form=form)

# Checkout Route
@routes.route('/checkout/<int:booking_id>', methods=['GET', 'POST'])
@login_required
...
# Leave Review Route
@routes.route('/review/<int:service_id>', methods=['GET', 'POST'])
@login_required
